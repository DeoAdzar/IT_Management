...
public class AssetsModel {
    ...
    private String purchase_date,tag,name,serial,notes,customfields,qrvalue,categorynama;

    public String getCategorynama() {
        return categorynama;
    }

    public void setCategorynama(String categorynama) {
